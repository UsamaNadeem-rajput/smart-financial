...
const List = () => {
  ...
  const checkAuth = async () => {
    try {
      const res = await axios.get(`https://smart-financial-production.up.railway.app/api/login/session`, { withCredentials: true });
      setUser(res.data);
  ...
  const fetchBusinesses = async () => {
    try {
      ...
      const response = await axios.get(`https://smart-financial-production.up.railway.app/api/showbusinesses`, {
  ...
  const handleDeleteBusiness = async (businessId) => {
    if (window.confirm('Are you sure you want to delete this business? This action cannot be undone.')) {
      try {
        await axios.delete(`https://smart-financial-production.up.railway.app/api/business/${businessId}`, {
          withCredentials: true
        });
